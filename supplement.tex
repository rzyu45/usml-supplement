...
In the loss \eqref{M-eq:loss}, the current and the speed are normalized by the standard deviation of the recorded quantity, the weight is $\lambda=1$, and the samples of the fault-on period are weighted by 3.
