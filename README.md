...
- S3. The gradient of the port-only training loss.
- S4. The numerical differentiation formula and its residual equation.
- S5. The machine parameters of the IEEE 14-bus case study.
